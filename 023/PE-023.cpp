...
inline bool isPerfect(long long int x) { return sumProperDivisors(x) == x; }

inline bool isDeficient(long long int x) { return sumProperDivisors(x) < x; }

inline bool isAbundant(long long int x) { return sumProperDivisors(x) > x; }
